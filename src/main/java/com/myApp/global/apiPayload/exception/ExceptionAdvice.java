...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException e, HttpHeaders headers,
        ...
        return handleExceptionInternalArgs(e, HttpHeaders.EMPTY, GeneralErrorCode.INVALID_INPUT_VALUE, request,
                errors);
    }
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException e, HttpHeaders headers,
                                                               HttpStatusCode status, WebRequest request) {
        return handleExceptionInternalConstraint(e, GeneralErrorCode.INVALID_INPUT_VALUE, headers, request);
    }
    ...
    public ResponseEntity<Object> exception(Exception e, WebRequest request) {
        ...
        return handleExceptionInternalFalse(e, GeneralErrorCode.INTERNAL_SERVER_ERROR.getHttpStatus(), request,
                e.getMessage());
    }
     ...
     *
     * @param e       발생한 {@link Exception}
     * @param reason  에러 코드와 메시지를 담고 있는 {@link BaseCode}
     * @param headers 응답에 포함될 HTTP 헤더
     * @param request 현재 요청 객체
     * @return 에러 응답 {@link ResponseEntity}
     */
    ...
    private ResponseEntity<Object> handleExceptionInternalFalse(Exception e,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(GeneralErrorCode.INTERNAL_SERVER_ERROR, errorPoint);
        return super.handleExceptionInternal(
                e,
                body,
                HttpHeaders.EMPTY,
